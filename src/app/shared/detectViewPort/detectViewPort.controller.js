(function() {
    ...
    angular.module('detectViewPort.controller', []);

    function DetectViewPortController($scope) {
  ...
  return withinViewport;
    ...
    angular
        .module('detectViewPort.controller')
        .controller('DetectViewPortController', DetectViewPortController);
})();